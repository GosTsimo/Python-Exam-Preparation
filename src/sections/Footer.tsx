    ...
    <footer className="relative py-16 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/80 backdrop-blur-sm rounded-full shadow-romantic mb-6">
        ...
        <div className="glass-card rounded-2xl p-6 mb-12 max-w-2xl mx-auto">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-pink-DEFAULT to-purple-DEFAULT flex items-center justify-center flex-shrink-0">
        ...
        <div className="border-t border-pink/20 pt-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a
                href="#"
                className="text-romantic-text-secondary hover:text-pink-dark transition-colors"
                onClick={(e) => {
                  e.preventDefault();
                  alert('Coming soon!');
                }}
